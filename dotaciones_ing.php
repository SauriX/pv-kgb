<?
$sql="SELECT usuarios.nombre, dotaciones_ingredientes.* FROM dotaciones_ingredientes
JOIN usuarios ON usuarios.id_usuario=dotaciones_ingredientes.id_usuario
WHERE dotaciones_ingredientes.activo=0 ORDER BY id_dotacion DESC";
$q=mysql_query($sql);
...
<div class="row mb10">
	<div class="col-md-12 text-right">
	    <a href="?Modulo=NuevaDotacion_ing" class="btn btn-success btn-sm">Nueva Dotación</a>
	</div>
</div>
