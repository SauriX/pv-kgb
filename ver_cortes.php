...
$sq_corte2="SELECT  *  FROM cortes WHERE id_corte = $v_corte";
$q_corte2=mysql_query($sq_corte2);
$row2 = mysql_fetch_assoc($q_corte2);
		...
		<div class="col-md-12">
			<div class="panel panel-primary">
				<div class="panel-heading">
					<h3 class="panel-title">Cortes Realizados</h3>
				</div>
						...
						<? while($ft=mysql_fetch_assoc($q0)){ ?>
							...
							<tr>
								...
								<?php
									...
									?>
									<a type="button" class="btn btn-primary btn-xs" href="#" onclick="imprimeCorte(<?=$ft['id_corte']?>)" >Reimprimir</a>
									...
									<?php if ($fact == 1): ?>
										...
										if ($ft['abierto']!=1):
											...
											?>
											<?php if ($n_ventas == 0): ?>
												<a href="?Modulo=Cortes&id_corte=<?=$ft['id_corte']?>" class="btn btn-primary btn-xs">Ajustes</a>
											<?php endif; ?>
										<?php endif; ?>
