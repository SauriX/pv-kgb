<?
	...
	$id_venta = 1;
	if(!is_numeric($id_venta)) exit('Falta id_venta');

	$sql = "SELECT*FROM ventas WHERE id_venta = $id_venta AND id_corte = 1";
	...
	<div class="col-md-12">
		<div class="panel panel-primary">
				...
				<div id="step3">
					<div class="row">
						<div class="col-xs-2">
							...
							<input type="text" class="form-control " name="cantidad" id="cantidad" maxlength="5" autocomplete="off" value="1">
						</div>
						<div class="col-xs-2">
							<label>Unidad</label>
						...
						<div class="col-xs-2">
							<label>Clave</label>
							<input type="text" class="form-control" name="clave" id="clave" autocomplete="off" value="01">
						</div>
						<div class="col-xs-4">
							<label>Descripción</label>
							<input type="text" class="form-control" name="descripcion" id="descripcion"  autocomplete="off" value="CONSUMO DE ALIMENTOS">
						</div>
						<div class="col-xs-2">
							<label>Importe</label>
							<input type="text" class="form-control total2" name="importe" id="importe" maxlength="10" autocomplete="off" readonly="readonly">
						</div>
					</div>
					...
					<div class="form-group">
    					...
    					<!--<div class="col-sm-2">
	    					<input type="text" class="form-control limpia" name="digitos" id="digitos" placeholder="# Cuenta (4 Digitos)" autocomplete="off" maxlength="4">
    					</div>-->

    					<label for="rfc" class="col-sm-2 control-label text-right">IVA:</label>
						<div class="col-sm-2">
							<input type="text" class="form-control limpia total2" id="iva" name="iva" readonly="readonly" maxlength="10" >
    					</div>
  					</div>
  					...
  					<div class="form-group">
						...
						<div class="col-sm-2">
							<input type="text" class="form-control total2" id="total" name="total" value="<?=$monto?>" maxlength="10">
    					</div>
  					</div>
				</div><!-- end step3-->
				</form>
			...
			<div class="panel-footer text-right">
				<label class="saldo_pendiente"><input type="checkbox" name="facturar_saldo" id="facturar_saldo" value="1"> Saldo pendiente por facturar </label>
