...
if($fecha2){
	...
	WHERE  (ventas.id_metodo=4 OR  ventas.id_metodo=28) AND pagada='1' AND  fecha BETWEEN '$fecha1' AND '$fecha2'";
	...
	JOIN usuarios ON usuarios.id_usuario=ventas.id_usuario
	JOIN metodo_pago ON metodo_pago.id_metodo=ventas.id_metodo
	WHERE  (ventas.id_metodo=4 OR  ventas.id_metodo=28) AND pagada='1' AND fecha='$fecha1' ";
...
<page backtop="20mm" backbottom="15mm" backleft="0mm" backright="0mm" footer="page">
