...
if($fecha2){
	...
	WHERE pagada=1 AND (ventas.id_metodo=3 OR Ventas.id_metodo=4)  AND fecha BETWEEN '$fecha1' AND '$fecha2'";
	...
	JOIN usuarios ON usuarios.id_usuario=ventas.id_usuario
	JOIN metodo_pago ON metodo_pago.id_metodo=ventas.id_metodo
	WHERE fecha='$fecha1' AND (ventas.id_metodo=3 OR Ventas.id_metodo=4) ";
