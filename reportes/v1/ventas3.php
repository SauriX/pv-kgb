...
<table width="730">
	<tr>	
		...
		<b>Reporte de Ventas del d&iacute;a <?=fechaTexto($fecha)?><br>entre las <?=$hora1?> y <?=$hora2?> horas.</b><br/>
...
<?  $query2=mysql_query("SELECT productos.id_producto,productos.nombre,venta_detalle.precio_venta,venta_detalle.cantidad FROM ventas
						...
						WHERE ventas.activo='1' AND ventas.fecha='$fecha' AND ventas.hora BETWEEN '$hora1' AND '$hora2'",$conexion);
...
$query3=mysql_query("SELECT productos.id_producto,productos.nombre,cancelaciones_detalle.precio_venta,cancelaciones_detalle.cantidad FROM cancelaciones
						...
						WHERE cancelaciones.activo='1' AND cancelaciones.fecha='$fecha' AND cancelaciones.hora BETWEEN '$hora1' AND '$hora2'");
