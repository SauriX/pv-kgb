...
WHERE dotaciones.fecha='$fecha' AND dotaciones.activo='1'";
...
<table width="730">
	<tr>	
		...
		<b>Reportes de Dotaciones de la fecha <?=fechaTexto($fecha);?></b><br/>
...
<table width="730" bgcolor="#e6e6e6">
	<tr>	
		...
		Dotaci&oacute;n a las <?=$ft['hora']?> por: <?=$ft['usuario']?> <? $id_detalle=$ft['id_dotacion']; ?>
		</td>
	</tr>
</table>
