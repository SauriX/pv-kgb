					...
					<div class="portlet light portlet-fit">
					  <div class="portlet-title">
					    <div class="caption">
					      ...
					      <span class="caption-subject font-dark sbold uppercase"><h3>AGREGAR SIN A <?=$nombre->nombre?>  </h3><span>
						  <?}?>
							  <br>
							  <br>
							  <br>
					  ...
					  <div class="portlet-body">
					    ...
					    <div class="row" >
					    <input type="hidden" disabled class="form-control numero" value="0" name="txtCantidad" id="txtCantidad">
...
$('#btnAgregarPro').on('click', function() {
	...
	$('#tblProductos #tblProductosBody tr').each(function(){
	  ...
	  if(id==0){
		$('#tblProductosBody').append('<tr data-id="'+cod+'" data-cantidad="'+cantidad+'" data-costoU="'+costoU+'" data-tipo="'+tipo+'"><td style=" text-align:center;">' + 'Sin'+ '</td> <td style=" text-align:center;">' + producto + '</td> <td style=" text-align:right;">$' + costoU + '</td>  <td style=" text-align:center;" > <button type="button" class="btn btn-sm btn-danger btn-xs" id="btnBorrar">x</button> </td> </tr>');
	  }else{
