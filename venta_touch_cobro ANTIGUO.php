...
$sql = "SELECT pagada,facturado FROM ventas WHERE id_venta = $id_venta";
$q = mysql_query($sql);
		  		...
		  		<div class="panel panel-success">
                	...
                	<div class="panel-body">
                		<form class="form-horizontal" id="form_cobrar">
	                		...
	                		<input type="hidden" name="monto_facturado" value="<?=$consumo?>" />
	                		<?
		                	if($facturale){
							?>
							...
							<div class="form-group form-group-lg">
								...
								<div class="col-sm-8">
									<input type="text" class="form-control total solo_numero no-select" id="recibe_txt" name="recibe_txt">
								</div>
							</div>
...
?>
									  ...
									  <label class="btn btn-default metodo_reset">
													<input type="radio" class="metodo_pago" name="id_metodo_pago" value="<?=$ft['id_metodo']?>" autocomplete="off" checked> <?=$ft['metodo_pago']?>
												</label>
<?
								}
?>
