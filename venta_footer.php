<div class="col-md-8">
	...
	if(!$touch){
		...
		<a id="listar_touch" class="btn btn-default btn-lg" style="margin-top: 10px; margin-left: 10px;" >Lista</a>
		<a class="btn btn-info btn-lg" style="margin-top: 10px; margin-left: 10px;" onclick="agregaSeparador()" >Separador</a>
		<!--
...
<div class="col-md-4" style="padding-left:0px;">
	<div class="form-group">
		<div class="input-group" style="margin-top: 10px; width: 100%;">
			...
			<input type="text" class="form-control input-lg total" readonly="1" id="total_totales" value="0.00" style="min-width: 140px;">
