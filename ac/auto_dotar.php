<?php
    ...
    $sql = "INSERT INTO dotaciones(id_usuario,fecha,comentario)VALUES('$id_usuario','$fecha','dotacion automatica')";
    $q = mysql_query($sql);
    if($q){
        ...
        foreach($dotados as $producto){
            ...
            $sql="INSERT INTO dotaciones_detalle (id_dotacion,id_producto,cantidad)VALUES('$id_venta','$id_producto','$cantidad')";
