...
<html lang="es">
    ...
    <meta name="description" content="Vende Fácil 3.0">

    <link rel="icon" href="favicon.ico">

    <title>Vende Fácil 3.0</title>
          ...
          <ul class="nav navbar-nav">
            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-menu" role="menu">
	              ...
	              <!--<li><a href="#" data-toggle="modal" data-backdrop="static" data-keyboard="false" data-target="#nuevoCodigo">Nuevo Código</a></li>-->
              </ul>
            </li>
			<?}?>
            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-menu" role="menu">
				...
				<!--  <li><a href="#" data-toggle="modal" data-backdrop="static" data-keyboard="false" data-target="#reportes_cortes2">Insumos</a></li>-->
	              ...
	              <!--<li class="divider"></li>
	              <li><a href="reportes/existencias.php" target="_blank">Existencias actuales</a></li>
	              <li class="divider"></li>
