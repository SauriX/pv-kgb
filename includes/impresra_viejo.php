...
function imprimir_corte($id_corte,$re=false){
  ...
  //Optiene la dotaciones de productos y los añade a existencias
	 $sql_dotacion= "SELECT * FROM dotaciones WHERE id_corte=$id_corte AND contar =1" ;
	 ...
	 $sql_merma= "SELECT * FROM merma WHERE id_corte=$id_corte  AND contar =1";
	 ...
	 $sql_venta= "SELECT * FROM ventas WHERE id_corte=$id_corte AND  contar =1";
   ...
   foreach($tags as $producto ){
      ...
      $pro= $nombre;
       ...
       /* unset($dota);
        ...
        $exis="  ";
        $merm="  ";*/
	      $var.= 'esc_pos_line($printer, "'.$pro.$space0.$dota.$space1.$merm.$space2.$total.$space3.$exis.'");';
