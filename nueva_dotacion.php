...
$(function() {
	...
	$('#id_producto_b').typeahead({
		...
		datos = {
			<? require('lista_ingredientes.php'); ?>
		}
		var newData = [];
...
function cobrar(){
		...
		$.post('ac/dotar.php',datos+"&"+dotaciones,function(data) {
...
function cobradoExito(){
	...
	$('#factura').val('');
	actualizar_total();
	window.open("?Modulo=Dotaciones&msg=1", "_self");
}
	...
	<div class="panel panel-default">
		...
		<form id="venta_form">
			<div class="panel-body" style="padding-top: 0px;" >
				<div class="row">
					<div class="col-md-12" id="lista_productos" style="overflow:scroll;height:300px"></div>
				</div>
			</div>
			<div class="col-md-3">
					 <div class="input-group col-md-12">
  ...
  <!-- Footer cobor -->
		<div class="panel-footer">
			<div class="row">
					...
					<div class="col-md-2">
						<button style="float: right;" class="btn btn-primary" type="button" data-toggle="modal" data-backdrop="static" data-keyboard="true" data-target="#venta_cobrar" id="cobrar_boton">Guardar Dotación</button>
					</div>
			</div>
  ...
  <div class="modal-dialog modal-md" style="margin-top: 60px;">
    <div class="modal-content">
      <div class="modal-body">
	      		...
	      		<h3 class="hidden_loader">¿Es correcta la Dotacion?</h3>
