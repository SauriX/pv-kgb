...
function opciones(codigo,parent){
	...
	$('#modal_opciones_productos').load('receta_producto.php?padre='+parent);
	$('#siguiente').hide();
	$('#verOpcionesProductos').modal(
		{
    		backdrop: 'static',
			...
			<div class="modal-footer">
				<div class="row">
					<div class="col-md-2" style="">
						<button type="button" id="cancela4" class="btn btn-default btn-lg" data-dismiss="modal">Cerrar</button>
					</div>
